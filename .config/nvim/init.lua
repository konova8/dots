...
-- Go up and down staying in the middle of the screen
vim.keymap.set('n', '<C-u>', '<C-u>zz')
vim.keymap.set('n', '<C-d>', '<C-d>zz')
vim.keymap.set('n', 'n', 'nzzzv')
vim.keymap.set('n', 'N', 'Nzzzv')

-- Better copy and pasting experience
...
vim.keymap.set('n', '<leader>fb', require('telescope.builtin').buffers, { desc = '[fb] Find existing Buffers' })
